...
**This content has moved to a [new location](https://datascience.ibm.com/docs/content/analyze-data/ml_dlaas_working_with_experiments.html). Check there for the most up-to-date information.**
...
* `training_references`: This section specifies the training definitions which need to be part of the experiment.
    ...
    - `compute_configuration.name`: This field specifies the resources that will be allocated for training and should be one of the following values - `k80` (1 k80 GPU), `k80x2` (2 k80 GPUs), `k80x4` (4 k80 GPUs), `p100` (1 p100 GPU), `p100x2` (2 p100 GPUs), `v100` (1 v100 GPU), `v100x2` (2 v100 GPUs).
